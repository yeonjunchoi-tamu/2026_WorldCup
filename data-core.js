...
(function () {
  ...
  const OV = {
    ...
    // 6.15
    "H-0-0": { st: "UP", date: "6.15", time: "11:00", ven: "levis" },
    "G-0-0": { st: "UP", date: "6.15", time: "14:00", ven: "hard" },
    ...
    "J-0-0": { st: "UP", date: "6.16", time: "20:00", ven: "att" },
    "J-0-1": { st: "UP", date: "6.16", time: "23:00", ven: "sofi" },
    // 6.17
    "K-0-0": { st: "UP", date: "6.17", time: "12:00", ven: "azteca" },
    "L-0-0": { st: "UP", date: "6.17", time: "15:00", ven: "linc", note: "주목" },
    "L-0-1": { st: "UP", date: "6.17", time: "18:00", ven: "mb" },
    "K-0-1": { st: "UP", date: "6.17", time: "21:00", ven: "bc" },
    // ── 라운드 2 (MD2) · CST 기준 ──
    // 6.18
    ...
    // 6.20
    "F-1-0": { st: "UP", date: "6.20", time: "12:00", ven: "mtlf" },
    "E-1-0": { st: "UP", date: "6.20", time: "15:00", ven: "mty", note: "주목" },
    "E-1-1": { st: "UP", date: "6.20", time: "19:00", ven: "nrg" },
    "F-1-1": { st: "UP", date: "6.20", time: "23:00", ven: "lumen" },
    // 6.21
    "H-1-0": { st: "UP", date: "6.21", time: "11:00", ven: "levis" },
    "G-1-0": { st: "UP", date: "6.21", time: "14:00", ven: "hard" },
    "H-1-1": { st: "UP", date: "6.21", time: "17:00", ven: "att" },
    "G-1-1": { st: "UP", date: "6.21", time: "20:00", ven: "mbs" },
    // 6.22
    "J-1-0": { st: "UP", date: "6.22", time: "12:00", ven: "att" },
    "I-1-0": { st: "UP", date: "6.22", time: "16:00", ven: "mtlf", note: "주목" },
    "I-1-1": { st: "UP", date: "6.22", time: "19:00", ven: "gil" },
    "J-1-1": { st: "UP", date: "6.22", time: "22:00", ven: "sofi" },
    // 6.23
    "K-1-0": { st: "UP", date: "6.23", time: "12:00", ven: "azteca" },
    "L-1-0": { st: "UP", date: "6.23", time: "15:00", ven: "linc" },
    "L-1-1": { st: "UP", date: "6.23", time: "18:00", ven: "mb" },
    "K-1-1": { st: "UP", date: "6.23", time: "21:00", ven: "bc" },
    // ── 라운드 3 (MD3) · CST 기준 (동시 킥오프) ──
    // 6.24
    "B-2-0": { st: "UP", date: "6.24", time: "14:00", ven: "bc" },
    "B-2-1": { st: "UP", date: "6.24", time: "14:00", ven: "sofi" },
    "C-2-0": { st: "UP", date: "6.24", time: "17:00", ven: "gil" },
    "C-2-1": { st: "UP", date: "6.24", time: "17:00", ven: "linc" },
    "A-2-0": { st: "UP", date: "6.24", time: "20:00", ven: "guad" },
    "A-2-1": { st: "UP", date: "6.24", time: "20:00", ven: "mty", note: "주목" },
    // 6.25
    "E-2-0": { st: "UP", date: "6.25", time: "15:00", ven: "mty" },
    "E-2-1": { st: "UP", date: "6.25", time: "15:00", ven: "nrg" },
    "F-2-0": { st: "UP", date: "6.25", time: "18:00", ven: "mtlf" },
    "F-2-1": { st: "UP", date: "6.25", time: "18:00", ven: "lumen" },
    "D-2-0": { st: "UP", date: "6.25", time: "21:00", ven: "levis" },
    "D-2-1": { st: "UP", date: "6.25", time: "21:00", ven: "lumen" },
    // 6.26
    "I-2-0": { st: "UP", date: "6.26", time: "14:00", ven: "mtlf", note: "주목" },
    "I-2-1": { st: "UP", date: "6.26", time: "14:00", ven: "gil" },
    "H-2-0": { st: "UP", date: "6.26", time: "19:00", ven: "att" },
    "H-2-1": { st: "UP", date: "6.26", time: "19:00", ven: "levis" },
    "G-2-0": { st: "UP", date: "6.26", time: "22:00", ven: "hard" },
    "G-2-1": { st: "UP", date: "6.26", time: "22:00", ven: "mbs" },
    // 6.27
    "L-2-0": { st: "UP", date: "6.27", time: "16:00", ven: "linc" },
    "L-2-1": { st: "UP", date: "6.27", time: "16:00", ven: "mb" },
    "K-2-0": { st: "UP", date: "6.27", time: "18:30", ven: "azteca" },
    "K-2-1": { st: "UP", date: "6.27", time: "18:30", ven: "bc" },
    "J-2-0": { st: "UP", date: "6.27", time: "21:00", ven: "att" },
    "J-2-1": { st: "UP", date: "6.27", time: "21:00", ven: "sofi" },
  };
  ...
  window.WC = {
    ...
    groupMatches: (g) => MATCHES.filter((m) => m.group === g),
  };
})();
